...
namespace Telegram.Bot.Services
{
    ...
    public class UpdateHandler : IUpdateHandler
    {
        ...
        private readonly string ipToPing = Environment.GetEnvironmentVariable("ipToPing");
            ...
            bool? goalIsSuccessNotFail)
        {
            ...
            if (goalIsSuccessNotFail == null)
            {
                ...
                string message = $"Bot was rebooted so we take a new goal it is = {goalIsSuccessNotFail}";
        ...
        static async Task<Message> SimpleReply(
        ...
        static string getSitePingResult(string siteOrBotAdress, int portToPing)
        {
            try
            {
